				...
				if (opcion_seleccionada == 1) {
					...
					while (continuar1 && registrado) {
						...
						if (opcion_admin == 1) {
							...
							hotelito.setCapacidadMaxAdultos(capacidades.get(1));
							hotelito.setCapacidadMaxNiños(capacidades.get(2));
							}
						} 
						...
						try {
							...
							if (opcion_Recepcionosta == 1) {
								...
								while (pedirAcompañantes==1) {
									...
									String niño= input("Digite si el acompañante es un infante: /n si /n no");
									boolean infante;
									if (niño.equals("si")) {
										infante = true;
									}
								...
								SimpleDateFormat llegada= new SimpleDateFormat((input("Fecha de llegada del grupo: ")));
								SimpleDateFormat max= new SimpleDateFormat((input("Fecha 2 dias antes de la de llegada: ")));
